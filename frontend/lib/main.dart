...
void main() {
  ...
  runApp(ChangeNotifierProvider(create: (_) => AppState(), child: const TrustGuardApp()));
}
...
class MainShell extends StatelessWidget {
  ...
  static const _screens = [
    HomeScreen(), TransactionsScreen(), AnalyzeScreen(), AlertsScreen(), ProfileScreen(),
  ];
...
class _BottomNav extends StatelessWidget {
  ...
  const _BottomNav({required this.current, required this.tabs, required this.unread, required this.onTap});
              ...
              child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Stack(clipBehavior: Clip.none, children: [
                    ...
                    if (e.value.hasAlert && unread > 0) Positioned(
                      top: -2, right: -4,
                      child: Container(
                        width: 17, height: 17,
                        decoration: BoxDecoration(
